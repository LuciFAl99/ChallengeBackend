...
public class ProfesorServicioImplementacion implements ProfesorServicio {
    ...
    @Override
    public ResponseEntity<Object> registro(Profesor profesor) {
    ...
    @Override
    public ResponseEntity<Object> modificarPropiedadProfesor(Authentication authentication, Long id, Map<String, Object> cambios) {
