package com.ChallengeBackend.challenge.Servicios.Implementacion;
...
public class AdminServicioImplementacion implements AdminServicio {
    ...
    @Override
    public ResponseEntity<Object> crearCurso(Curso curso) {
    ...
    @Override
    public ResponseEntity<Object> eliminarAlumno(Long id) {
    ...
    @Override
    public ResponseEntity<Object> eliminarCurso(Long id) {
    ...
    @Override
    public ResponseEntity<Object> eliminarMateriaDelCurso(Long id, String materia) {
        Optional<Curso> optionalCurso = cursoRepositorio.findById(id);
        if (optionalCurso.isPresent()) {
            Curso curso = optionalCurso.get();
    ...
    @Override
    public ResponseEntity<Object> eliminarAlumnoCurso(Long id, Long alumnoId) {
        Optional<Curso> optionalCurso = cursoRepositorio.findById(id);
        if (optionalCurso.isPresent()) {
    ...
    @Override
    public ResponseEntity<Object> modificarPropiedadProfesor(Long id, Map<String, Object> cambios) {
    ...
    @Override
    public ResponseEntity<Object> modificarPropiedadAlumno(Long id, Map<String, Object> cambios) {
        Optional<Alumno> optionalAlumno = alumnoRepositorio.findById(id);
        if (optionalAlumno.isPresent()) {
            Alumno alumnoExistente = optionalAlumno.get();
            List<String> propiedadesModificadas = new ArrayList<>();
    ...
    @Override
    public ResponseEntity<Object> modificarPropiedadCurso(Long id, Map<String, Object> cambios) {
        Optional<Curso> optionalCurso = cursoRepositorio.findById(id);
        if (optionalCurso.isPresent()) {
            Curso cursoExistente = optionalCurso.get();
            List<String> propiedadesModificadas = new ArrayList<>();
    ...
    @Override
    public ResponseEntity<Object> inscribirProfesorACurso(Long profesorId, Long cursoId) {
    ...
    @Override
    public ResponseEntity<Object> cambiarProfesorCurso(Long id, Long nuevoProfesorId) {
        Optional<Curso> optionalCurso = cursoRepositorio.findById(id);
        if (optionalCurso.isPresent()) {
            Curso cursoExistente = optionalCurso.get();
    ...
    @Override
    public ResponseEntity<Object> inscribirAlumnoACurso(Long alumnoId, Long cursoId) {
        Optional<Alumno> optionalAlumno = alumnoRepositorio.findById(alumnoId);
        if (!optionalAlumno.isPresent()) {
            return new ResponseEntity<>("Alumno no encontrado", HttpStatus.NOT_FOUND);
        }
