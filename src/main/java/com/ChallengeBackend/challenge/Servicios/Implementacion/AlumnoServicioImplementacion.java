...
public class AlumnoServicioImplementacion implements AlumnoServicio {
    ...
    @Override
    public ResponseEntity<Object> registro(Alumno alumno) {
    ...
    @Override
    public ResponseEntity<Object> inscribirAlumnoACurso(Authentication authentication, Long cursoId) {
        String email = authentication.getName();
    ...
    @Override
    public ResponseEntity<Object> modificarPropiedad(Authentication authentication, Long id, Map<String, Object> cambios) {
        String email = authentication.getName();
